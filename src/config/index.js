...
const CommonConfig = {
  ...
  email: "vibhor.88.gupta@gmail.com",
  ...
  social: [
    {
      ...
      link: "https://github.com/realVibhorGupta",
    ...
    {
      name: "LinkedIn",
      link: "https://linkedin.com/in/realVibhorGupta",
    },
    {
      name: "Facebook",
      link: "https://facebook.com/realVibhorGupta",
    },
    {
      name: "Twitter",
      link: "https://twitter.com/realVibhorGupta",
    },
    {
      name: "Email",
      link: "mailto:vibhor.88.gupta@gmail.com",
    },
    {
      name: "CV",
      link: "https://github.com/realVibhorGupta/resume-101",
      icon: <Description />,
    },
  ],
};
...
const ProjectsConfig = {
  ...
  //     description:
  //       "A web-based experiment independent event display for High Energy Physics.",
  //     links: [
  //       {
  //         tooltip: "See source",
...
const CustomSectionsConfig = [
  ...
  // ABOUT SECTION
  {
    ...
    content: (
      <>
        ...
        <p>
          An easily excited and a highly passionate full stack developer trying
          to support the world of open source with his little efforts. Full of
          eagerness to learn and work on new technologies. :)
        </p>

        <h4>{Icons["code"]} programming languages</h4>
        ...
        <h4>{Icons["web"]} backend frameworks</h4>
        <p className="programming-icons">
          {Icons["nodejs"]}
          {Icons["nextjs"]}
          {Icons["express"]}
        </p>
        <h4>{Icons["test"]} test framework </h4>
        <p className="programming-icons">
          {Icons["jest"]}
          {Icons["cypress"]}
          {Icons["mocha"]}
        </p>
        <h4>{Icons["web"]} apis</h4>
        <p className="programming-icons">
          {Icons["graphql"]}
          {Icons["rest"]}
          {Icons["socketIO"]}
        ...
        <h4>{Icons["devOps"]} devOps</h4>
        <p className="programming-icons">{Icons["docker"]}</p>
        <h4>{Icons["devOps"]} version system</h4>
        <p className="programming-icons">
          {Icons["github"]}
          {Icons["git"]}
        </p>
  ...
  // },
  {
    ...
    content: (
      <>
        <h4 style={{ fontSize: "2em" }}>
          {Icons["helpoutline"]} what are my certifications?
        </h4>
        <h5>All these certifications can be found on <LinkedInIcon/></h5>
        <p>
        
          <br />
          <ul className="flex">
            <li>2023 Creating API Documentation </li>
            <li>2023 Web Programming Foundations</li>
            <li>2023 Express Essential Training</li>
            <li>2023 HTML Essential Training</li>
            <li>2023 HTTP Essential Training</li>
            <li>2023 Introduction to Web Design and Development</li>
            <li>2023 JavaScript Essential Training</li>
            <li>2023 JavaScript: Modern Browser APIs</li>
            <li>2023 Learning ECMAScript 6+ (ES6+)</li>
            <li>2023 Designing RESTful APIs</li>
            <li>2023 CSS Essential Training</li>
            <li>2023 SQL Essential Training</li>
            <li>Search Techniques for Web Developers</li>
            <li>2023 Git Essential Training</li>
            <li>2022 Building Resilience” by Tatiana Kolovou</li>
            <li>2022 Digital Marketing Garage Certification Certificate</li>
            <li>2015 JAVA and J2EE CERTIFIED FROM EDUNET LEARNING Finalist</li>
          </ul>
        </p>
